const FAQs = () => {
  ...
  const quickTips = [
    ...
    },
    {
      icon: "👥",
      title: "Family Use",
      tip: "Set up individual profiles for each family member to ensure personalized interactions for everyone."
    }
  ];
      ...
      <section className="py-20 bg-cream-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-cream-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-cream-700 transform hover:scale-105 transition-all duration-200 shadow-lg">
              Contact Support
            </button>
            <button className="border-2 border-cream-600 text-cream-700 px-8 py-4 rounded-lg font-semibold hover:bg-cream-600 hover:text-white transition-all duration-200">
              Schedule a Call
            </button>
          </div>
        </div>
